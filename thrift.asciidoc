...
* http://code.google.com/apis/protocolbuffers/docs/overview.html[Protocol
  Buffers]
* https://thrift.apache.org/static/files/thrift-20070401.pdf[Thrift white paper (pdf)]
* https://erikvanoosten.github.io/thrift-missing-specification/[Thrift missing specification]

Translations 其他译本
----------------

* http://diwakergupta.github.io/thrift-missing-guide/[English]
  by Diwaker Gupta of https://github.com/diwakergupta
